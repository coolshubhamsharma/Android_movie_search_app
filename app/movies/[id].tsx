...
const MovieInfo = ({label,value}:MovieInfoProps)=>(
  <View className='flex-col items-start justify-center mt-5'>
    <Text className='text-light-300 font-normal text-sm'>
      {label}
    </Text>
  ...
  return (
    <View className='bg-primary flex-1'>
      <ScrollView contentContainerStyle={{
        ...
        <TouchableOpacity className='absolute bottom-8 rounded-lg py-1 flex flex- row items-center justify-center z-50 right-0 mx-5 bg-accent left-0' onPress={router.back}>
